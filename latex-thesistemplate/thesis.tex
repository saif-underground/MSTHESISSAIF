...
\title{FORECASTING CUSTOMER ELECTRICITY LOAD DEMAND IN THE POWER TRADING AGENT COMPETITION USING MACHINE LEARNING}
...
%\AuthorDegrees{B.S.}
\date{August 2016}
\DeptName{Master\textquotesingle s Program in Computer Science}
...
\include{chapter4}         % Chapter 4 customer description 
\include{chapter5}         % Chapter 5 Prediction Mechanism and result discussion
